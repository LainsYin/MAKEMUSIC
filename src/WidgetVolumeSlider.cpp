...
void VlcWidgetVolumeSlider::setTrack(const int &track)
{
    _vlcAudio->setTrack(track);
}

int VlcWidgetVolumeSlider::track() const
{
    int track =   _vlcAudio->track();
    return track;
}

int VlcWidgetVolumeSlider::trackCount() const
{
    int count = _vlcAudio->trackCount();
    return count;
}

QStringList VlcWidgetVolumeSlider::trackDescription() const
{
    return _vlcAudio->trackDescription();
}

QList<int> VlcWidgetVolumeSlider::trackIds() const
{
    QList<int> tracks = _vlcAudio->trackIds();
